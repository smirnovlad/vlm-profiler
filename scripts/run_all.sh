#!/bin/bash
# Run all 8 models on 2 GPUs in parallel.
# GPU 0: 4 smaller models, GPU 1: 4 larger models
...
# GPU 1: larger models (~7-13B each)
run_gpu1() {
...
run_gpu0 > outputs/gpu0.log 2>&1 &
PID0=$!
run_gpu1 > outputs/gpu1.log 2>&1 &
PID1=$!

echo "Launched GPU 0 (PID $PID0) and GPU 1 (PID $PID1)"
echo "Logs: outputs/gpu0.log, outputs/gpu1.log"
echo "Monitor: tail -f outputs/gpu0.log outputs/gpu1.log"
