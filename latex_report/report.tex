...
We test 8 models that cover the main VLM families available on HuggingFace:
...
8 & \texttt{idefics2-8b} & 8\,403M & IDEFICS2 (8B) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[nosep]
  ...
  \item 1 CPU run
\end{itemize}
That gives about 360 experiments across 8 models and 3 datasets.
...
Based on the baseline experiment:
\begin{enumerate}[nosep]
