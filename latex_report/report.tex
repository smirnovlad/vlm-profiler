...
\begin{enumerate}[nosep]
  ...
  \item FP16 alone gives 4.6$\times$ on prefill and 1.9$\times$ on decode for \texttt{llava-1.5-7b}.  The next layer of wins is architectural (FlashAttention-2, speculative decoding), not another dtype flip.
